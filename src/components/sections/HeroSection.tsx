          ...
          <CardContent className="relative p-6 sm:p-8 md:p-12 lg:p-16">
            <div className="flex flex-col lg:flex-row items-center justify-between">
              <div className="flex-1 lg:pr-8 text-center lg:text-left">
                <div className="inline-flex items-center space-x-2 bg-gradient-to-r from-cyan-500/20 to-fuchsia-500/20 px-4 sm:px-6 py-2 rounded-full border border-cyan-400/40 mb-6 sm:mb-8 backdrop-blur">
                ...
                <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black tracking-tight mb-4 sm:mb-6 bg-gradient-to-r from-cyan-200 via-white to-fuchsia-300 bg-clip-text text-transparent neon-text">
                  Saran Jaya Thilak
                </h1>
                <p className="text-lg sm:text-xl md:text-2xl mb-6 sm:mb-8 text-cyan-200/90 font-light tracking-[0.15em]">
                ...
                <div className="flex flex-col sm:flex-row space-y-4 sm:space-y-0 sm:space-x-6 items-center justify-center lg:justify-start">
                  <Button 
                    ...
                    className="w-full sm:w-auto bg-gradient-to-r from-cyan-500 via-indigo-500 to-fuchsia-500 hover:from-cyan-400 hover:via-indigo-400 hover:to-fuchsia-400 text-white px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg rounded-xl shadow-lg shadow-cyan-500/40 hover:shadow-fuchsia-500/50 transition-all duration-300 hover:scale-[1.03] uppercase tracking-wider"
                  >
                    Explore My Work
                  ...
                  <Button 
                    ...
                    variant="outline" 
                    className="w-full sm:w-auto bg-white/5 border-cyan-400/40 text-cyan-100 hover:bg-cyan-500/10 hover:border-cyan-300 px-6 sm:px-8 py-3 sm:py-4 text-base sm:text-lg rounded-xl backdrop-blur-sm transition-all duration-300 hover:scale-[1.03] uppercase tracking-wider"
                  >
              ...
              <div className="mt-8 lg:mt-0 lg:block">
                <div className="relative animate-cyber-float">
                  ...
                  <div className="absolute -top-4 -right-4 w-8 h-8 bg-cyan-400 rounded-full border-4 border-black/40 shadow-[0_0_20px_rgba(34,211,238,0.9)] animate-pulse"></div>
                </div>
              </div>
            </div>
          </CardContent>
