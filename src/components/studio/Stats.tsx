...
const Stats = () => (
  <section className="pb-24 sm:pb-32">
    <div className="shell pad-x">
      <Reveal>
        <div className="card-ink px-7 py-12 sm:px-12 sm:py-16">
          <Eyebrow tone="light">By the numbers</Eyebrow>
          <div className="mt-10 grid gap-10 sm:grid-cols-2 lg:grid-cols-4">
            {STATS.map((s, i) => (
              <Reveal key={s.label} delay={i * 90}>
                <div className="flex flex-col gap-2 border-t border-white/12 pt-5">
                  <span className="text-[clamp(2.5rem,5vw,4rem)] font-semibold leading-none tracking-[-0.04em]">
